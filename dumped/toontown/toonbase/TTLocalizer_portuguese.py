...
QuestDialogDict = {160: {GREETING: "",
 ...
 6252: {GREETING: "",
        LEAVING: "",
        QUEST: "Oi _avName_. Você está aqui para ajudar com minhas entregas?\aIsso é ótimo! Com esse zíper quebrado é muito difícil fazer as entregas sozinha.\aDeixe-me ver... Ok, vai ser fácil. O caubói George pediu uma cítara semana passada.\aVocê poderia levá-la para ele? _where_",
...
[
"Espero que o Mickey tenha me dado chocolates ou flores!",
"Esses corações são bons para aumentar o Laff!",
"Eu quero ir a uma festa dos Namorados!",
"Espero que o Mickey me leve ao Kooky Cafe!",
"Mickey é um ValenToon tão bom!",
"O que você comprou para o seu ValenToon?",
"Mickey nunca perdeu um Dia dos ValenToons!",
],
[
"Espalhe o amor por aí!",
"Foi muito legal ter você aqui!",
]
)

WitchMinnieChatter = (
[ # Saudações
"Bem-vindo à Magicland... quero dizer, Melodyland!",
"Olá, meu nome é Magic Minnie! Qual é o seu?",
"Olá, acho que você é encantadora!",
"Feliz Dia das Bruxas!",
"Feliz Dia das Bruxas, %!",
],
[ # Comments
"Ouvi dizer que Tabitha tem guloseimas para a Realmente Kool Katz que pode pregar peças!",
...
"Ouvi dizer que Tabitha tem guloseimas para a Really Kool Katz que pode pregar peças!",
...
"Todo mundo está falando sobre os novos escritórios de campo do Agitador!"
]
