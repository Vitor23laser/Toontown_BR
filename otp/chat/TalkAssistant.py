...
class TalkAssistant(DirectObject.DirectObject):
    ...
    def receiveGuildTalk(self, fromAv, fromAC, avatarName, message, scrubbed = 0):
        ...
        if not self.isThought(message):
            ...
            newMessage = TalkMessage(self.countMessage(), self.stampTime(), message, fromAv, avatarName, fromAC, accountName, None, None, None, None, TALK_GUILD, None)
    ...
    def receiveGuildMessage(self, message, senderId, senderName):
        error = None
        if not self.isThought(message):
            newMessage = TalkMessage(self.countMessage(), self.stampTime(), message, senderId, senderName, None, None, None, None, None, None, TALK_GUILD, None)
            self.historyComplete.append(newMessage)
            self.historyGuild.append(newMessage)
    ...
    def receiveOpenSpeedChat(self, type, messageIndex, senderId, name = None):
        ...
        newMessage = TalkMessage(self.countMessage(), self.stampTime(), message, senderId, name, None, None, None, None, None, None, TALK_OPEN, None)
        self.historyComplete.append(newMessage)
        self.historyOpen.append(newMessage)
    ...
    def receiveAvatarWhisperSpeedChat(self, type, messageIndex, senderId, name = None):
        ...
        newMessage = TalkMessage(self.countMessage(), self.stampTime(), message, senderId, name, None, None, localAvatar.doId, localAvatar.getName(), localAvatar.DISLid, localAvatar.DISLname, TALK_WHISPER, None)
        self.historyComplete.append(newMessage)
        self.historyOpen.append(newMessage)
        self.addToHistoryDoId(newMessage, senderId)
        messenger.send('NewOpenMessage', [
    ...
    def receivePlayerWhisperSpeedChat(self, type, messageIndex, senderId, name = None):
        ...
        newMessage = TalkMessage(self.countMessage(), self.stampTime(), message, None, None, senderId, name, localAvatar.doId, localAvatar.getName(), localAvatar.DISLid, localAvatar.DISLname, TALK_WHISPER, None)
        self.historyComplete.append(newMessage)
        self.historyOpen.append(newMessage)
